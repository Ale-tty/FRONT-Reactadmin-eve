  ...
  const convertDataRequestToHTTP = (type, resource, params) => {
    ...
    switch (type) {
      ...
      case UPDATE:
        ...
        console.log(params)
        options.headers = new Headers({ 'If-Match': `${params.previousData._etag}` })
        delete params.data.id;
        delete params.data._links;
        delete params.data._updated;
        delete params.data._created;
        delete params.data._etag;
      ...
      case DELETE:
        ...
        //console.log(params.previousData._etag)
        //var res = params.data._items.filter(obj => obj.id === params.id)
        options.headers = new Headers({ 'If-Match': `${params.previousData._etag}` })
        break;
      default:
